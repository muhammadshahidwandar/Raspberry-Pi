/***********************************************************************
 * This header file contains the PmodMicSpi class definition.
 * Its main purpose is to communicate with the Digilent PmodMic chip using
...
public:
    pmodmicSpi();
    pmodmicSpi(std::string devspi, unsigned char spiMode, unsigned int spiSpeed, unsigned char spibitsPerWord);
    ~pmodmicSpi();
